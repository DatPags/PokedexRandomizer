Public Class MoveDisplay : Inherits Grid
    ...
    Private Shared _catPhysical As BitmapImage
    Private Shared _catStatus As BitmapImage
    Private Shared _catSpecial As BitmapImage
    ...
    Public Property MoveCategory() As String
        ...
        Set(value As String)
            Select Case value
                Case "Physical"
                    _category.Source = _catPhysical
                Case "Special"
                    _category.Source = _catSpecial
                Case "Status"
                    _category.Source = _catStatus
            End Select
        End Set
    End Property
